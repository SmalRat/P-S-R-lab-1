...
naiveBayes <- setRefClass("naiveBayes",
       ...
       fields = list(data = "data.frame", labels = "vector", labels_quantity = "numeric", unique_words = "numeric"),
       methods = list(
                    ...
                    predict = function(message)
                    {
                         ...
                         for (word in words){
                           if (!(word %in% data$Word)){
                             non_zero_probability = 1/(sum(current_topic$n) + unique_words)
                             relevant_data[nrow(relevant_data)+1,] <- c(c(word), rep(c(0), times=ncol(data)-1))
                             print(word)
                           }
                         }
                         print(relevant_data)
