...
neutral_posts_counted <- count(neutral_posts_text, splitted, sort=TRUE)
neutral_posts_text
neutral_posts_counted

discrimination_posts_text <- filter(tidy_text, label == "discrim")
discrimination_posts_counted <- count(discrimination_posts_text, splitted, sort=TRUE)
...
naiveBayes <- setRefClass("naiveBayes",
       ...
       methods = list(
                    ...
                    fit = function(X, y)
                    {
                         ...
                         neutral_posts_counted["P(word|neutral)"] <- (neutral_posts_counted["n"]+1)/(sum(neutral_posts_counted$n) + unique(neutral_posts_counted$n))
                         discrimination_posts_counted["P(word|discrimination)"] <- (discrimination_posts_counted["n"]+1)/(sum(discrimination_posts_counted$n) + unique(discrimination_posts_counted$n))
                         discrimination_posts_counted
                         unique(discrimination_posts_counted$n)
